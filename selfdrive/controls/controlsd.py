...
class Controls:
  ...
  def update_events(self, CS):
    ...
    #print("autoHoldActivated in controlsd : ", CS.autoHoldActivated)

    #if CS.autoHoldActivated:     ## gm/interface.py also has same code. Which one is better?
      #self.events.add(EventName.autoHoldActivated)
