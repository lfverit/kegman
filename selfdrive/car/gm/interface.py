...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=None):
    ...
    ret.steerActuatorDelay = 0.14  # Default delay, not measured yet
  ...
  def update(self, c, can_strings):
    ...
    ##print("self.CS.lka_button = ", self.CS.lka_button,"self.CS.prev_lka_button = ", self.CS.prev_lka_button)

    ## maybe lka_button cat be used for another function...
    ##if cruiseEnabled and self.CS.lka_button and self.CS.lka_button != self.CS.prev_lka_button:
      ##self.CS.lkMode = not self.CS.lkMode
    if self.CS.autohold_button and self.CS.autohold_button != self.CS.prev_autohold_button:
      self.CS.autoHold = not self.CS.autoHold
      if self.CS.autoHold:
        self.CS.autoHoldActive = True
      ##print("lka_button clicked!!!")
      print("self.CS.autoHold = ", self.CS.autoHold)
      print("self.CS.autoHoldActive = ", self.CS.autoHoldActive)
  ...
  def apply(self, c):
    ...
    can_sends = self.CC.update(enabled, self.CS, self.frame,
                               ...
                               c.hudControl.leadVisible, c.hudControl.visualAlert, self.paddleFrame)
